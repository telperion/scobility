...
type MixedTooltipItem = TooltipItem<"line" | "bubble">;

const generateOptions = (
  label_callback: (context: MixedTooltipItem) => string | string[] | void
) => ({
  responsive: true,
  ...
  plugins: {
    tooltip: {
      callbacks: {
        label: (context: MixedTooltipItem) => {
...
export function ScobilityHome({
  ...
  const runScobilityCalculations = async () => {
    ...
    const label_callback = (context: MixedTooltipItem) =>
